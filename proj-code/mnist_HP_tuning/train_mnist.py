...
wandb.init(
    ...
    tags=["mnist", "resnet18", "optimizer", "lr", "batch_size", "dropout", "weight_decay"])
config = wandb.config
...
train_val_dataset = datasets.MNIST(root='./data', train=True, download=True, transform=train_transform)
